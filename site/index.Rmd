...
In addition, all quiz questions in the lectures have been now converted into a [swirl](http://swirlstats.com/swirlify/index.html) course so that students can answer the quiz questions directly from within R, without all the additional information shown in the slides. 
...
These case studies are meant as group exercises (3-4 students) but can be easily split into individual tasks. Each group is expected to work in R Markdown for communicating their work progress and results.
