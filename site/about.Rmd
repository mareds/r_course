...
The development of the *swirl* course has been a joint effort in the [R-Lab 2.0](https://rlab.blogs.uni-hamburg.de) project, which is one of the so-called [Lehrlabor](https://www.universitaetskolleg.uni-hamburg.de/universitaetskolleg-2-0/lehrlabor.html) (teaching lab) projects at the University of Hamburg, funded by BMBF (01PL17033).

Design of the questions: Saskia A. Otto, [Jan Conradt](https://github.com/JanCo93)<br>
Coding of course with swirlify: Jan Conradt, Saskia A. Otto<br>
